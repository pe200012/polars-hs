...
- [x] **Step 1: Create `Polars.GroupBy`**
...
- [x] **Step 2: Re-export `Polars.GroupBy`**
...
- [x] **Step 3: Expose the module in `package.yaml`**
...
- [x] **Step 5: Run HLint on Haskell source and tests**
...
- [x] **Step 6: Commit public GroupBy API**
